                    ...
                    <div class="span12">
                        ...
                        <div class="tabbable tabbable-custom">
                            <ul class="nav nav-tabs">
                                ...
                                <li class=""><a href="#tab_1_5" data-toggle="tab"><i class="icon-briefcase"></i> Account Details</a></li>
                                <li class=""><a href="#tab_1_6" data-toggle="tab"><i class="icon-folder-open"></i> Bid Wallet</a></li>
                            </ul>
                            {{-- tabs panes --}}
